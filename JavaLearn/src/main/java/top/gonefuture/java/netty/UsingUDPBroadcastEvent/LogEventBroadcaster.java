...
public class LogEventBroadcaster {
    ...
    public void run() throws Exception {
        ...
        for (;;) {
            ...
            if (len <pointer) {
                // file was reset 如果有必要，将文件指针设置到该文件的最后一个字节
                pointer =len;
            } else {
                // Content was added
    ...
    public static void main(String... args) throws Exception {
        ...
        args[1] = "C:\\Users\\gonefuture\\Desktop\\software\\shell\\test.log";
        // 启动后，在linux的shell里执行 `nc -l -u -p 9999` 监听UDP的广播
